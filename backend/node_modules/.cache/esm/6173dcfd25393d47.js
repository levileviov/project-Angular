let express,cors,signup,getLoginStatus,googleLogin,login,logout,addTask,changeTaskLevel,changeTaskStatus,getCounterTasks,getTask,getTasks,removeTask,restoreTask,updateTask,addProduct,getCartProducts,getProduct,getProducts,removeProduct,restoreProduct,updateProduct,addContact,getContact,getContacts,removeContact,restoreContact,updateContact,addCustomer,getCustomer,getCustomers,removeCustomer,restoreCustomer,updateCustomer;_253‍.w("express",[["default",["express"],function(v){express=v}]]);_253‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_253‍.w("./sqlConnect");_253‍.w("./services/signup",[["signup",["signup"],function(v){signup=v}]]);_253‍.w("./services/login",[["getLoginStatus",["getLoginStatus"],function(v){getLoginStatus=v}],["googleLogin",["googleLogin"],function(v){googleLogin=v}],["login",["login"],function(v){login=v}],["logout",["logout"],function(v){logout=v}]]);_253‍.w("./services/tasks",[["addTask",["addTask"],function(v){addTask=v}],["changeTaskLevel",["changeTaskLevel"],function(v){changeTaskLevel=v}],["changeTaskStatus",["changeTaskStatus"],function(v){changeTaskStatus=v}],["getCounterTasks",["getCounterTasks"],function(v){getCounterTasks=v}],["getTask",["getTask"],function(v){getTask=v}],["getTasks",["getTasks"],function(v){getTasks=v}],["removeTask",["removeTask"],function(v){removeTask=v}],["restoreTask",["restoreTask"],function(v){restoreTask=v}],["updateTask",["updateTask"],function(v){updateTask=v}]]);_253‍.w("./services/products",[["addProduct",["addProduct"],function(v){addProduct=v}],["getCartProducts",["getCartProducts"],function(v){getCartProducts=v}],["getProduct",["getProduct"],function(v){getProduct=v}],["getProducts",["getProducts"],function(v){getProducts=v}],["removeProduct",["removeProduct"],function(v){removeProduct=v}],["restoreProduct",["restoreProduct"],function(v){restoreProduct=v}],["updateProduct",["updateProduct"],function(v){updateProduct=v}]]);_253‍.w("./services/contacts",[["addContact",["addContact"],function(v){addContact=v}],["getContact",["getContact"],function(v){getContact=v}],["getContacts",["getContacts"],function(v){getContacts=v}],["removeContact",["removeContact"],function(v){removeContact=v}],["restoreContact",["restoreContact"],function(v){restoreContact=v}],["updateContact",["updateContact"],function(v){updateContact=v}]]);_253‍.w("./services/customers",[["addCustomer",["addCustomer"],function(v){addCustomer=v}],["getCustomer",["getCustomer"],function(v){getCustomer=v}],["getCustomers",["getCustomers"],function(v){getCustomers=v}],["removeCustomer",["removeCustomer"],function(v){removeCustomer=v}],["restoreCustomer",["restoreCustomer"],function(v){restoreCustomer=v}],["updateCustomer",["updateCustomer"],function(v){updateCustomer=v}]]);
